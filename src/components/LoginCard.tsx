        ...
        <div className="border-t border-gray-100 dark:border-zinc-800 px-6 py-4">
          ...
          <div className="flex items-center justify-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-black hover:bg-gray-800 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-white text-xs font-medium pl-3 pr-4 py-2 rounded-lg transition-colors"
            >
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-[8px] uppercase tracking-wider opacity-80">Tải về từ</span>
